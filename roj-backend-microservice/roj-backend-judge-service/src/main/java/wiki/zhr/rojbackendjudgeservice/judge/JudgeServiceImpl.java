...
import wiki.zhr.rojbackendjudgeservice.judge.codesandbox.CodeSandboxFactory;
import wiki.zhr.rojbackendjudgeservice.judge.codesandbox.CodeSandboxProxy;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        String language = questionSubmit.getLanguage();  // 获取提交的语言
        String code = questionSubmit.getCode(); // 获取提交的代码
        // 获取输入用例
        String judgeCaseStr = question.getJudgeCase();  // 获取一个题目的输入例子，这里是从question里取得，是String
        List<JudgeCase> judgeCaseList = JSONUtil.toList(judgeCaseStr, JudgeCase.class);   // 将String转换成列表
